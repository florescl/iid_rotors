...
def __MAIN__():
    ...
    u_func = [[[0 for z in xrange(-dim,dim)] for y in xrange(-dim,dim)] for z in xrange(0,20)]
    ...
    while n_iters < n_iters_try:
        ...
        #print 'before update', particle_x, particle_y
        ...
        if particle_x==0 and particle_y==0:
            ...
            if n_succesive_visits==4:
                ...
                n_excursions+=1
                n_succesive_visits=0
                print n_iters_try, n_sites_visited, n_sites_visited/pow(n_iters_try,0.66667), n_excursions, math.sqrt(pow(particle_x,2.0)+pow(particle_y,2.0))
